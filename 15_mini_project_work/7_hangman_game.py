...
CATEGORY_LIST = [['"Продукты питания, еда"', 'желток', 'арбуз', 'банан', 'хлеб', 'яблоко', 'колбаса',
                  'сахар', 'творог', 'хрен', 'шоколад', 'каша', 'макароны', 'рис', 'лаваш'],
                 ['"Животные и растения"', 'ягода', 'комар', 'фазан', 'таракан', 'ландыш', 'гиббон',
                  'щука', 'еж', 'зебра', 'щенок', 'голубь', 'утка', 'ежик',
                  'рыба', 'улитка', 'цыпленок', 'яблоня', 'цветок'],
                 ['"Природа"', 'лес', 'корень', 'река', 'песок', 'лен', 'айсберг', 'цветение', 'закат'],
                 ['"Транспорт"', 'вагон', 'двигатель', 'корабль', 'трамвай', 'аэропорт',
                  'самолет', 'авиалиния', 'автомобиль', 'экспресс', 'такси'],
                 ['"Музыкальные инструменты"', 'пианино', 'гитара', 'скрипка', 'барабан', 'кларнет', 'саксофон',
                  'укулеле'],
                 ['"Другие слова"', 'дом', 'железо',
                  'игла', 'мама', 'нос',
                  'окно',
                  'солнце', 'улица',
                  'фонарь',
...
def main():
    ...
    while game_is_going_on:
        ...
        category_name = get_word_category_name(CATEGORY_LIST, category_num)
